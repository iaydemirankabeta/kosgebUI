...
export class PendingCallsComponent {
  ...
  pendingCalls: Call[] = [
    {
      id: 1,
      title: 'Endüstriyel Aktif Gürültü Kontrolü/Engelleme Sistemi',
      BIName: 'ISUZU',
      totalOffer: '50',
      offer: '22',
      badget: 'Enerji ',
      badgetColor: '#27ae60',
      tags: '#ActiveNoiceCanelling #ANC #GürültüEngelleme #GürültüKontrolü',
      piece: '200',
      url: [
      ...
      expectationDescription:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque ut ornare nisl. Nunc vitae mauris enim. In accumsan ullamcorper lectus.',
    },
    {
      id: 2,
      title: 'Kozmetik Teknoloji Çözümler',
      BIName: 'ZARA',
      totalOffer: '70',
      offer: '56',
      piece: '500',
      badget: 'Kozmetik',
      badgetColor: '#8e44ad',
      tags: '#cosmetic,#technology,#application #GürültüEngelleme #GürültüKontrolü',
      url: [
        { name: 'Özel Sorun/İhtiyaç/Fırsat Alanı' },
        { name: 'Teknoloji Tedarikçisinden Beklentisi' },
        { name: 'Aradığı Teknoloji Tedarikçisi Özellikleri' },
  ...
  filters: Filter[] = [
    ...
    },
    {
      ...
      options: [
        ...
        {
          id: 7,
          name: 'Yabancı Sermayeli İşletmeler',
          value: 7,
          category: 'İşletme Tipi',
        },
      ],
    },
    {
      ...
      options: [
        {
          ...
          value: 1,
          category: 'Sertifikasyonlar ve Belgeler',
        },
        {
          id: 2,
          name: 'ISO 13485 - Tıbbi Cihazlar Kalite Yönetim Sistemi',
          value: 2,
          category: 'Sertifikasyonlar ve Belgeler',
        },
        {
        ...
        {
          id: 4,
          name: 'ISO 15378 - İlaçlar için birincil ambalaj malzemeleri',
          value: 4,
          category: 'Sertifikasyonlar ve Belgeler',
        },
      ],
      ...
      options: [
        {
          ...
          name: 'İstanbul',
          value: 1,
          category: 'İşletme Faaliyet Yeri',
        },
    ...
    },
    {
      ...
      options: [
        {
          id: 1,
          name: 'Doğrudan Tedarikçi (1. Derece Tedarikçi)',
          value: 1,
          category: 'Tedarikçi Tipi',
        },
        {
          id: 2,
          name: 'Dolaylı Tedarikçi (2. Seviye Tedarikçi)',
          value: 2,
          category: 'Tedarikçi Tipi',
        },
        {
          id: 3,
          name: 'Mal Tedarikçisi',
          value: 3,
          category: 'Tedarikçi Tipi',
        },
    ...
    },
    {
      ...
      options: [
        {
          id: 1,
          name: 'Düzey 1 İstatistiki Bölge',
          value: 1,
          category: 'İstatistiki Bölge',
        },
        {
          id: 2,
          name: 'Düzey 2 İstatistiki Bölge',
          value: 2,
          category: 'İstatistiki Bölge',
        },
        {
          id: 3,
          name: 'Düzey 3 İstatistiki Bölge',
          value: 3,
          category: 'İstatistiki Bölge',
        },
      ],
      ...
      options: [
        {
          ...
          name: 'Evet',
          value: 1,
          category: 'Ar-Ge Projesi Tamamlamış Olma Durumu',
        },
        {
          id: 2,
          name: 'Hayır',
      ...
      options: [
        {
          ...
          name: 'Evet',
          value: 1,
          category: 'Hâlihazırda Ar-Ge Projesi Yürütme Durumu',
        },
        {
          id: 2,
          name: 'Hayır',
  ...
  revizeBoolean: boolean = false;
  closeDetailModal() {
    this.revizeBoolean = true;
