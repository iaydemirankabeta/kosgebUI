...
const ELEMENT_DATA: UsersModel[] = [
  {name:"Gizem Turanlı",email:"gizemturanli@ankabeta.com.tr",phone:"5432231693",role:"Platform Yetkilisi",createdBy:"Admin"},
  {name:"Hasan Oruç",email:"hasanoruc@ankabeta.com.tr",phone:"5432541193",role:"İmza Yetkilisi",createdBy:"Admin"},
  {name:"Doğukan Kızıltepe",email:"dogukankiziltepe@ankabeta.com.tr",phone:"5431231663",role:"Temas Kişisi",createdBy:"Admin"},
  {name:"Tufan Yazıcı",email:"tufanyazici@ankabeta.com.tr",phone:"543631692",role:"Temsilci",createdBy:"Admin"},
